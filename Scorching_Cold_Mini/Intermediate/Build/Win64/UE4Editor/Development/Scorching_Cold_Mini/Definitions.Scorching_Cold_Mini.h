...
#define ORIGINAL_FILE_NAME "UE4Editor-Scorching_Cold_Mini.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Scorching_Cold_Mini
#define DEPRECATED_FORGAME DEPRECATED
#define SCORCHING_COLD_MINI_API DLLEXPORT
